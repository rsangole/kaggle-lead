...
# Read the model
lrn_tgtencode_over_rf <- qs::qread("data/results/stratified-sampling-approach/lrn_tgtencode_over_rf.qs")
...
test_predictions <- lrn_tgtencode_over_rf$predict_newdata(test_dat_to_predict)
...
fwrite(prediction, "data/results/stratified-sampling-approach/lrn_tgtencode_over_rf-probs.csv")
